    ...
    public class Limb : MonoBehaviour
    {
        ...
        class Editor
        {
            ...
            void DoMoveHandle(Transform transform)
            {
                ...
                EditorGUI.BeginChangeCheck();
                var fmh_130_61_638528429454605964 = Quaternion.identity; var fmh_130_118_638753853188806820 = Quaternion.identity; position = Handles.FreeMoveHandle(position, size, Vector3.zero, Handles.SphereHandleCap);
                if (EditorGUI.EndChangeCheck())
                {
