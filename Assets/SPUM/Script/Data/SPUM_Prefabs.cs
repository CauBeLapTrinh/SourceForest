...
public class SPUM_Prefabs : MonoBehaviour
{
    ...
    public void OverrideControllerInit()
    {
        ...
        // Kiểm tra nếu runtimeAnimatorController là AnimatorOverrideController
        RuntimeAnimatorController baseController = animator.runtimeAnimatorController;
        if (baseController is AnimatorOverrideController existingOverrideController)
        {
            baseController = existingOverrideController.runtimeAnimatorController;
        }

        // Tạo AnimatorOverrideController mới
        OverrideController = new AnimatorOverrideController();
        OverrideController.runtimeAnimatorController = baseController;

        // Lấy tất cả các AnimationClip từ AnimatorController gốc
        ...
        // Gán OverrideController mới cho Animator
        animator.runtimeAnimatorController = OverrideController;

        // Khởi tạo StateAnimationPairs
